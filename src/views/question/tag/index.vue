<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input :placeholder="$t('table.tagName')" v-model="listQuery.tagName" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter"/>
    ...
    <el-table
      ...
      <el-table-column :label="$t('table.tagName')" align="center">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="40%">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="90px" style="width: 420px; margin-left:50px;">
        <el-form-item :label="$t('table.tagName')" prop="realName">
...
<script>
  import { fetchList, createOne, deleteOne, activeOne, updateOne} from '@/api/questions/tag'
  ...
  export default {
    ...
    methods: {
      ...
      handleFilter() {
        ...
        this.getList()
        this.listQuery.tagName = undefined
      },
      resetTemp() {
        this.temp = {
          tagName: '',
